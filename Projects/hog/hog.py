...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        return announce_highest(who, gain if gain > previous_high else previous_high, score1 if who else score0)
    # END PROBLEM 7
    return say
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    n, results = 1, []
    while n < 11:
        results += [make_averaged(roll_dice, num_samples)(n, dice)]
        n += 1
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(new_score, opponent_score):
        if opponent_score - score > margin or opponent_score > new_score:
            return 0
        else:
            return num_rolls
