...
def group_by_centroid(restaurants, centroids):
    ...
    for r in restaurants:
        result += [[find_closest(restaurant_location(r), centroids)] + [r]]
...
def rate_all(user, restaurants, feature_fns):
    ...
    for r in restaurants:
        if r in reviewed:
            res[restaurant_name(r)] = user_rating(user, restaurant_name(r))
        else:
            res[restaurant_name(r)] = predictor(r)
    return res
    # END Question 9
